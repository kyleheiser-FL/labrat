...
export const SAMPLE_INVENTORY: ShopProduct[] = [
  ...
  },
  {
    ...
    description: 'Purity: 99%+. Sourced from certified laboratories. Master antioxidant tripeptide researched for oxidative stress reduction, cellular detoxification, and immune support pathways.',
    category: 'Beauty & Radiance',
    price: 80,
    inventory: 0,
    sourceRestriction: 'china'
