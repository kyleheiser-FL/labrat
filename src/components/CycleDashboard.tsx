...
import { Check, CheckCircle2, Circle, Calendar, Weight, Activity, History, Trash2, CalendarDays, PlusCircle, AlertCircle, Syringe, CheckSquare, Smartphone, Bell, BellRing, Clock, ShieldAlert, Loader2, Info } from 'lucide-react';
