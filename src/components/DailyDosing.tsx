      ...
      <div key={c.id} className={`labrat-card p-4 sm:p-5 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 sm:gap-4 ${logged ? 'border-emerald-500/25' : ''}`}>
        <div className="min-w-0">
          ...
          <div className="mt-2 pl-[22px] flex flex-col gap-0.5">
            ...
            <span className="labrat-frequency-chip mt-1.5 w-full rounded-lg border border-slate-800/70 bg-[#0b1222]/55 px-2.5 py-1.5 text-[12px] font-semibold text-slate-200">
    ...
    <div className="relative max-w-2xl mx-auto pb-8" id="daily-dosing">
      ...
      <div className="labrat-card-strong p-4 sm:p-5 overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          ...
          <div className="labrat-mini-surface flex items-center justify-between sm:justify-start gap-1 rounded-xl p-1 w-full sm:w-auto">
